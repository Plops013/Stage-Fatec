                    ...
                    <div class="col-md-12">
                        <div class="card bg-dark text-white">
                            <div class="card-header"> 
                                <h1 class="text-secondary display-4"><?php
                                $empresa = new Empresa();
                                $e = $empresa->getVagaEmpresa($v->cnpj_empresa);
                                echo $e->nome_fantasia;
                                ?></h1> </div>
                            <div class="card-body">
                                <h4 class="font-weight-bold"><?php echo $v->nome ?></h4>
                                <hr class="bg-white text-white">
                                <p><span class="text-secondary font-weight-light">Descrição: </span><?php echo $v->desc ?></p>
                                <p><span class="text-secondary font-weight-light">Localização: </span> <?php echo $v->cidade ?> - <?php echo $v->estado ?></p>
                                <hr class="bg-white text-white">
                                <h6 class="font-weight-bold"><span class="text-secondary font-weight-light">Vagas Disponiveis:</span> <?php echo $v->qtd_vagas ?>  </h6>
                                 <hr class="bg-white text-white">
